...
export default function Navber(){
    ...
    return(
        <div className="flex gap-18 items-center justify-center bg-gray-200 text-gray-800 py-1 fixed bottom-0 left-0 w-full border-t-2 border-gray-300">
            <Link onClick={() => navControl('home')} href='/home' className="flex flex-col text-center items-center justify-center cursor-pointer">
            ...
            <Link onClick={() => navControl('tran')} href='/home' className="text-center cursor-pointer">
            ...
            <Link onClick={() => navControl('profile')} href='/home' className="text-center cursor-pointer">
